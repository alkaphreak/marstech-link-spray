...
public class DashboardServiceImpl implements DashboardService {
  ...
  public DashboardDto createDashboard(String dashboardName) {
    return createDashboard(
        new DashboardDto(UUID.randomUUID().toString(), dashboardName, List.of(), null));
  }
  ...
  public DashboardDto getDashboard(String id) {
    ...
    return new DashboardDto(
        entity.getId(), entity.getName(), entity.getItems(), entity.getDescription());
  }
